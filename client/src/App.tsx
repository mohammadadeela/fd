    ...
    if (this.state.error) {
      return (
        <div style={{ padding: "40px", fontFamily: "monospace", maxWidth: "800px", margin: "0 auto" }}>
          <h1 style={{ color: "#c00", fontSize: "20px" }}>Application Error</h1>
          <p style={{ color: "#333", marginTop: "12px" }}>{this.state.error.message}</p>
          <pre style={{ background: "#f5f5f5", padding: "16px", borderRadius: "6px", overflow: "auto", fontSize: "13px", marginTop: "16px" }}>
